...
export default function NuovaFattura() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const fatturaData = {
      ...
      data: dataDB,  // Salva come YYYY-MM-DD
      importo: parseFloat(form.importo),
      fornitore_id: form.fornitore_id,
    };

    console.log("Salvando fattura:", fatturaData);

    const { data, error } = await supabase.from("fatture").insert([fatturaData]).select();
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-8 space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button
                type="button"
                onClick={() => setShowNewFornitore(!showNewFornitore)}
